...
export function buildPromptParts(agent, options = {}) {
  ...
  // =========================================================================
  //  SZUM BLISKI — AKAPIT ZE SPEC 18.0, CYTOWANY DOSLOWNIE
  //
  //  PO CO ISTNIEJE (SPEC 11.0): modul RAG nie umie odroznic "blisko
  //  tematycznie" od "odpowiada na pytanie" i NIGDY NIE BEDZIE UMIAL.
  //  Te decyzje podejmuje model odpowiadajacy, a ten akapit jest JEDYNYM
  //  miejscem, w ktorym to sie dzieje.
  //
  //  DWA POMIARY, KTORE TLUMACZA TO LEPIEJ NIZ REGULA — zostawione tutaj
  //  celowo, zeby nikt nie skrocil akapitu jako oczywistosci:
  //
  //    "jakie sa dzialania niepozadane AMOKSYCYLINY"
  //        -> dzialania niepozadane LENALIDOMIDU            score 0,6433
  //    "jaki jest termin przedawnienia roszczen z tytulu REKOJMI"
  //        -> przedawnienie roszczen ZE STOSUNKU PRACY      score 0,6275
  //
  //  W obu przypadkach oba dokumenty sa poprawne, wyszukiwanie zadzialalo
  //  poprawnie, a odpowiedz bez tego akapitu bylaby konfabulacja. Score
  //  przewyzsza siedem z dziesieciu pytan, na ktore korpus MA prawdziwa
  //  odpowiedz — czyli ZADEN PROG tego nie odetnie (11.0, 11.1e).
  //  Podnoszenie RAG_MIN_SCORE nie jest wiec alternatywa dla tego akapitu.
  //
  //  TRESC JEST PRZEPISANA ZNAK W ZNAK z docs/rag-SPEC.md, sekcja 18.0,
  //  blok ```text```. Nie parafrazowac przy refaktorach — to jest kontrakt,
  //  nie sugestia stylistyczna.
  //
  //  WCHODZI WYLACZNIE, GDY AGENT MA rag_search. Bez narzedzia nie ma
  //  fragmentow, do ktorych akapit by sie odnosil, a zdanie "Fragmenty
  //  dokumentow ponizej…" wskazywaloby na cos, czego w prompcie nie ma.
  // =========================================================================
  if (tools.includes("rag_search")) {
    parts.push({
      id: "rag_szum",
      label: "Fragmenty z wyszukiwania",
      source: "Sekcja „Narzędzia” → Przeszukiwanie dokumentów",
      text:
