...
export const PARAMETERS = [
  ...
  {
    // ZASADY ZA WIEDZA I NARZEDZIAMI — ta sama kolejnosc, co w prowadzeniu
    // mentora (GUIDED_STEPS w lib/mentor/prompt.js) i z tego samego powodu:
    // najpierw kim agent jest i skad bierze wiedze, na koncu jak ma sie
    // zachowywac. Mentor omawiajacy zasady PRZED RAG-iem nie mial jak
    // zobaczyc, ze czesc zasad aplikacja dokleja juz sama.
    id: "rules",
    label: "Zasady",
    icon: "📋",
    fixed: false,
...
//
// KOLEJNOSC PUSHOWANIA MUSI ODPOWIADAC KOLEJNOSCI W PARAMETERS — i to jest
// RECZNIE UTRZYMYWANE LUSTRO, ktore nie ma jak samo sie zaktualizowac.
// Przestawiajac karty w PARAMETERS, przestaw je TAKZE tutaj. Ta lista wyznacza
// nie tylko stan poczatkowy: MasterDetailCreator liczy ja przy kazdym renderze
// i to z niej bierze sie miejsce karty dolozonej przez mentora.
