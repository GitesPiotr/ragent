...
export const KNOWLEDGE_MODES = ["none", "all", "selected"];
...
export function dbAgentToState(row) {
  ...
  return {
    ...
    // Tylko do odczytu — potrzebne, by czat wiedzial, z ktorego projektu
    // brac pliki wiedzy. NIE trafia do patcha zapisu.
