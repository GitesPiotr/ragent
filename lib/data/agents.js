...
// UWAGA PRZY DOKLADANIU KOLUMNY: ta lista jest uzywana ZAROWNO do odczytu,
// jak i do `.select()` po zapisie. Kolumna dopisana do stateAgentToDbPatch,
// ale POMINIETA tutaj, zapisze sie do bazy i NIE WROCI — kreator po
// przeladowaniu pokaze pusta wartosc, tak jakby zapis sie nie udal.
// Zlapane wlasnie na rag_collection_id: przelacznik narzedzia utrzymywal sie,
// a wybor kolekcji znikal, bo `tools` bylo na liscie, a nowa kolumna nie.
const FULL_COLUMNS = `${COLUMNS}, persona, provider, model, temperature, rules, tools, qas, input_settings, output_format, knowledge_mode, knowledge_file_ids, rag_collection_id`;
