...
export async function sendChatOllama({
  ...
  //
  // OD RUNDY 6 PRZYCHODZI Z GORY, a nie powstaje tutaj. Wczesniej ta linia
  // brzmiala `const ctx = { sources: [] }` i byla jedynym miejscem, w ktorym
  // kontekst istnial — przez co narzedzie u Ollamy wiedzialo wiecej niz to samo
  // narzedzie u Anthropica. Skladanie ctx nalezy do trasy, nie do dostawcy.
