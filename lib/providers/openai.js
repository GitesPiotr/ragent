...
//   Samo OpenAI w tym trybie nie zwraca cytowań — wyszukiwanie w internecie
//   jest dostępne tylko dla Anthropic i Ollamy. Do rundy 6 stała tu twarda
//   pusta lista, przez co narzędzie odkładające źródła (dziś web_search_local,
//   po rundzie 7 także RAG) traciło je bez śladu właśnie u tego dostawcy.
export async function sendChatOpenAI({
  ...
  for (let i = 0; i < MAX_TOOL_ITERATIONS; i++) {
    ...
    for (const call of calls) {
      ...
      // ctx jako trzeci argument — do rundy 6 go tu nie bylo (patrz ta sama
      // zmiana w anthropic.js).
